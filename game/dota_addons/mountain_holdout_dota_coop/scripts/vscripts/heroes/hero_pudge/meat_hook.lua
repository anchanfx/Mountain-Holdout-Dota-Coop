...
function RetractMeatHook( keys )
	...
	local direction = (targetLocation - casterLocation):Normalized()
	...
	Timers:CreateTimer(0, function()
		...
		casterLocation = targetLocation + (casterLocation - targetLocation):Normalized() * (distance - hookSpeed)
		--target:SetAbsOrigin(targetLocation)
		caster:SetAbsOrigin(casterLocation)
		...
		if distance > 100 then
			...
			FindClearSpaceForUnit(caster, casterLocation, false)
