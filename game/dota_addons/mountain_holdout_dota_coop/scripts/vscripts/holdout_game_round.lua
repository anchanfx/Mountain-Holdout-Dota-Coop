...
function CHoldoutGameRound:Begin()
	CHoldoutGameRound.nExecutingRespawns = 0
	CHoldoutGameRound.nExecutedRespawns = 0
	CHoldoutGameRound.bQuestTextDirty = false
...
function CHoldoutGameRound:IsFinished()
	...
	local nExecutingRespawns = CHoldoutGameRound.nExecutingRespawns
	if nEnemiesRemaining == 0 and nExecutingRespawns == 0 then
		return true
	end
